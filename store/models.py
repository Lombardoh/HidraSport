...
class Importar(models.Model):
    ...
    largo = models.CharField(max_length=20, blank=True, null=True)
    cadera = models.CharField(max_length=20, blank=True, null=True)
    manga = models.CharField(max_length=20, blank=True, null=True)
    siza = models.CharField(max_length=20, blank=True, null=True)
    tiro = models.CharField(max_length=20, blank=True, null=True)
    bajo_busto = models.CharField(max_length=20, blank=True, null=True)
    cintura = models.CharField(max_length=20, blank=True, null=True)
