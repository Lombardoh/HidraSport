...
class Product(models.Model):
    ...
    manga = models.CharField(max_length=50)
    siza = models.CharField(max_length=50)
    tiro = models.CharField(max_length=50)
    bajo_busto = models.CharField(max_length=50)
    cintura = models.CharField(max_length=50)
